  ...
  module.exports = {
    ...
    config: {
      matlabRootPath: {
        ...
        description: 'Specify the MATLAB root path (type `matlabroot` in your MATLAB command window)',
        default: '',
        order: 1
      },
      computerArch: {
        ...
        description: 'Specify the computer architecture (type `computer(\'arch\')` in your MATLAB command window)',
        default: '',
        order: 2
      }
    },
